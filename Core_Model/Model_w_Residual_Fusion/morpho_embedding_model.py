...
class MorphoTransformerFuser(nn.Module):
    ...
    def _build_sinusoidal_pos_enc(seq_len: int, dim: int) -> torch.Tensor:
        """Returns sinusoidal positional encodings, shape (1, seq_len, dim)."""
    ...
    def forward(
        ...
        Returns
        -------
        (B, proj_dim)  — attention-fused morphological word vector.
        """
...
class MorphoEmbeddingModel(nn.Module):
    ...
    def forward(
        ...
        """
        See class docstring for full parameter / return documentation.
        """
        ...
        # (4) Residual fusion 
        v_final = v_morph + char_contribution   # residual, not replacement
